                ...
                <div className="sensors d-flex flex-wrap align-items-center justify-content-between">
                  ...
                  >
                    ...
                    <div className="home-services-content">
                      ...
                      <p className="mb-0">{sensorData.bodyTemperature}°C</p>
                    </div>
                  </div>
                  <div
                    className="sensor d-flex align-items-center gap-15"
                  ...
                  >
                    ...
                    <div className="home-services-content">
                      ...
                      <p className="mb-0">
                        {sensorData.environmentTemperature}°C
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div className="home-services-content">
                      <h4>Humidity</h4>
                      <p className="mb-0">{sensorData.humidity} gm-3</p>
                    </div>
                  </div>
                  <div
                    className="sensor d-flex align-items-center gap-15"
                  ...
                  >
                    ...
                    <div className="home-services-content">
                      ...
                      <p className="mb-0">{sensorData.heartPulseRate} bpm</p>
                    </div>
                  </div>
                  <div
                    className="sensor d-flex align-items-center gap-15"
